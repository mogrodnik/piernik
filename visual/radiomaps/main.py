...
def cli_params(argv):
   ...
   try:
      ...
      opts,args=getopt.getopt(argv,"adhf:i:k:l:m:n:R:cpPrtSuvxyz",["dump","help","file","convolve","contours","lin=","log","spectral","yt=","tz=","pz=","iz=","rz=","pr=","vp=","cp="])
